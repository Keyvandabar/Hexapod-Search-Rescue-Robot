...
def tripodMove():
    ...
    #ta backward and up
    s.write("#5 P1300 #4 P1700 #6 P1750 \r".encode())#cr backward
    s.write("#17 P1700 #16 P1300 #18 P1100 \r".encode())#fl backward
    s.write("#25 P1700 #24 P1200 #26 P1200\r".encode())#bl backward
    sleep(0.1)
    #ta down
    s.write("#16 P1600 #17 P1500 #24 P1600 #25 P1500 #4 P1500 #5 P1500\r".encode())
    sleep(0.1)
    #tbOnly backward and up
    s.write("#9 P1300 #8 P1700 #10 P1800 \r".encode())#fr backward
    s.write("#1 P1200 #0 P1800 #2 P1800 \r".encode())#br backward
    s.write("#21 P1700 #20 P1300 #22 P1250\r".encode())#cl backward
    sleep(0.1)
    #move ta push
    s.write("#4 P1500 #5 P1500 #6 P1350 \r".encode())#cr push
    s.write("#16 P1600 #17 P1500 #18 P1650 \r".encode())#fl push
    s.write("#24 P1600 #25 P1500 #26 P1750 \r".encode())#bl push
    sleep(0.1)
    #tbDown
    ...
    sleep(0.1)
    #move tb push
    s.write("#20 P1600 #21 P1500 #22 P1650 \r".encode())#cl push
    s.write("#0 P1400 #1 P1500 #2 P1350 \r".encode())#br push
    s.write("#8 P1500 #9 P1500 #10 P1250 \r".encode())#fr push
    sleep(0.1)
    #ta down
    s.write("#16 P1600 #17 P1500 #24 P1600 #25 P1500 #4 P1500 #5 P1500\r".encode())
    sleep(0.1)
...
#p = GPIO.PWM(pinOut, 50) # set PWN to 50Hz for pin 17
