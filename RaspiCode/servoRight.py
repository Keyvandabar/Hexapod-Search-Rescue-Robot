...
def tripodMove():
    ...
    #ta backward and up
    s.write("#5 P1300 #4 P1700 #6 P1750 \r".encode())#cr forward
    s.write("#17 P1700 #16 P1300 #18 P1900 \r".encode())#fl backward
    s.write("#25 P1700 #24 P1200 #26 P1800\r".encode())#bl backward
    sleep(0.1)
    #ta down
    s.write("#16 P1600 #17 P1500 #24 P1600 #25 P1500 #4 P1500 #5 P1500\r".encode())
    sleep(0.1)
    #tbOnly backward and up
    s.write("#9 P1300 #8 P1700 #10 P1800 \r".encode())#fr forward
    s.write("#1 P1200 #0 P1800 #2 P1800 \r".encode())#br forward
    s.write("#21 P1700 #20 P1300 #22 P1850\r".encode())#cl backward
    sleep(0.1)
    #move ta push
